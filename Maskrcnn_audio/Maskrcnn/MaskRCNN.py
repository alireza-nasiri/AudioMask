...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        # rpn_class_logit for each P, each rpn_class_logit is [batch, num of anchors, 2]
        ...
        if mode == "training":
            ...
            # came from.
            _, _, _, active_class_ids = KL.Lambda(lambda x: dg.parse_image_meta_graph(x),
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers):
        ...
        # Data generators
        train_generator = dg.data_generator(train_dataset, self.anchors, self.config, shuffle=True,
                                         batch_size=self.config.BATCH_SIZE)
        val_generator = dg.data_generator(val_dataset, self.anchors, self.config, shuffle=True,
                                       batch_size=self.config.BATCH_SIZE,
                                       augment=False)
        ...
        self.keras_model.fit_generator(
            ...
            max_queue_size=25,
            workers=workers,
            use_multiprocessing=self.config.MULTI,
    ...
    def mold_inputs(self, images):
        ...
        for image in images:
            ...
            molded_image = dg.mold_image(molded_image, self.config)
            # Build image_meta
            image_meta = dg.compose_image_meta(
